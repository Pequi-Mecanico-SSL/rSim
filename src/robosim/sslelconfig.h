#ifndef SSLELCONFIG_H
#define SSLELCONFIG_H
...
namespace SSLELConfig
{
    ...
    private:
        ...
        double fieldLength = 4.50;
        double fieldWidth = 3.00;
        double fieldRad = 0.50;
        double fieldFreeKick = 0.50;
        double fieldPenaltyWidth = 1.35;
        double fieldPenaltyDepth = 0.50;
        double fieldPenaltyPoint = 3.00;
        double fieldMargin = 0.50;
        double fieldRefereeMargin = 0.0;
        double wallThickness = 0.02;
        double goalThickness = 0.02;
        double goalDepth = 0.18;
        double goalWidth = 0.8;
    ...
    public:
        ...
        void setFieldType(int value)
        {
            ...
            case 0: // Division A
                ...
                setFieldPenaltyDepth(0.50);
                setFieldPenaltyPoint(3.00);
                setGoalWidth(0.80);
                break;
            case 1: // Division B
                setRobotsCount(12);
    ...
    private:
        ...
        int wheel2Angle = 225;
        int wheel3Angle = 300;
        double radius = 0.090; // change here
        double height = 0.146; // change here
